...
class StoreProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'image' => 'nullable|string', // Vous pouvez ajuster cette règle en fonction de la manière dont vous gérez les images (par exemple, si vous utilisez des fichiers téléchargés, vous pourriez utiliser 'image' au lieu de 'string')
