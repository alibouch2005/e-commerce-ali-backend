...
class RegisterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'role' => 'required|in:admin,client,livreur', // Le rôle est requis et doit être l'un des suivants : admin, client ou livreur
            'phone' => 'required|string|max:20', // Le numéro de téléphone est requis, doit être une chaîne de caractères et ne pas dépasser 20 caractères
